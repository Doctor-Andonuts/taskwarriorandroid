...
//                form.setValue(App.KEY_QUERY, input);
    ...
    private void refreshContext() {
        new Tasks.ActivitySimpleTask<String>(this){
            ...
            @Override
            protected String doInBackground() {
                return ac.taskGetCurrentContext();
            }
            ...
            public void finish(String result) {
                ...
                MenuItem reportsMenu = navigation.getMenu().findItem(R.id.menu_nav_context);
                reportsMenu.getSubMenu().clear();

                addContextMenuItem(result, reportsMenu.getSubMenu());
            }

            private void addContextMenuItem(String title, SubMenu menu) {
                menu.add(title).setIcon(R.drawable.ic_action_context)
                        ...
                        new MenuItem.OnMenuItemClickListener() {
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                final CharSequence[] items = ac.taskGetPossibleContexts();
...
//                                reload();
    ...
    private void setContext(final String twContext) {
        if (null == ac) return;
        new Tasks.ActivitySimpleTask<String>(this){

            @Override
            protected String doInBackground() {
                return ac.taskContext(twContext);
            }
            ...
            public void finish(String result) {
                if (null != result) { // Error
                    ...
                    controller.messageShort("Context Set");
                    list.reload();
                }
            }
        }.exec();
